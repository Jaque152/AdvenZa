    ...
    <div className="min-h-screen bg-night-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-5xl w-full grid md:grid-cols-5 gap-0 items-stretch bg-night-900/60 rounded-3xl border border-night-800 backdrop-blur-xl shadow-2xl overflow-hidden relative z-10">
        ...
        <motion.div 
          ...
          className="md:col-span-2 bg-gradient-to-br from-fire-600 to-amber-500 p-12 flex flex-col justify-center items-center text-center relative overflow-hidden"
        >
          {/* Pattern decorativo */}
        ...
        <motion.div 
          ...
          className="md:col-span-3 p-10 md:p-14 flex flex-col justify-center"
        >
          <form onSubmit={handleAddToCart} className="space-y-10">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  required type="number" min="1" step="0.01" value={amount} onChange={(e) => setAmount(e.target.value ? Number(e.target.value) : "")}
                  placeholder="0.00"
            ...
            <div className="pt-6 bg-night-950/50 p-6 rounded-2xl border border-night-800/50">
              ...
              <button 
                type="submit" disabled={!planId || !amount}
