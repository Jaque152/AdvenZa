...
function ProgramsSection() {
  ...
  const programsLogic = [
    ...
    { id: "curso-innovacion-creatividad-empresarial", price: 1200, featured: false },
  ];
...
function Footer() {
  ...
  const legalLinks = [
    { name: t("links.privacy"), href: `/${locale}/legal/privacy` },
    { name: t("links.terms"), href: `/${locale}/legal/terms` },
    { name: t("links.refunds"), href: `/${locale}/legal/refunds` }
  ];
